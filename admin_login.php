            ...
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto my-5">
                ...
                <div class="card my-5">
                    ...
                    <div class="card-body">
                        ...
                        <h4 class="text-center my-2"> Admin LogIn </h4>

                        <hr class="my-4">

                        <form class="form" name="form1" action="admin_login_con.php" method="post">
                            ...
                            <div class="my-4">
                                <!--LogIn Button-->
                                <input type="submit" id="btnLogin" name="action" value="Admin Log In"
                                    class="btn btn-danger col-12 text-uppercase">
